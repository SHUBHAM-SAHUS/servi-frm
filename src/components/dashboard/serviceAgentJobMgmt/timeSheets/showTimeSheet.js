                                ...
                                <div className="sf-card-body mt-2">
                                    <div className="timesheet-filter ext-div">
                                        ...
                                        <fieldset className="sf-form pr-2">
                                            <Field name="drop-1" label="Period" placeholder={Strings.allocate_supervisor}
                                                type="text" dataSource="" component={CustomSelect} />
                                        </fieldset>
                                        <fieldset className="sf-form pr-2">
                                            <Field name="drop-1" label="Staff" placeholder={Strings.allocate_supervisor}
                                                type="text" dataSource="" component={CustomAutoCompleteSearch} />
                                        </fieldset>
                                        <fieldset className="sf-form pr-2">
                                            <Field name="drop-1" label="SA Filter" placeholder={Strings.allocate_supervisor}
                                                type="text" dataSource="" component={CustomAutoCompleteSearch} />
                                        </fieldset>
                                        <button className="bnt bnt-active">Submit</button>
                                    </div>
                                    ...
                                    <div className="staff-timesheet-table sf-timesheet-table">
                                        ...
                                        <div className="timesheet-add-nr-scroll">
                                            <div className="sf-c-table org-user-table mb-0">
                                                ...
                                                <div className="tr">
                                                    ...
                                                    <span className="td"><fieldset className="sf-form">
                                                        <Field name="drop-2" type="text" component={customInput} /> </fieldset>
                                                    </span>
                                                    <span className="td"><fieldset className="sf-form">
                                                        <Field name="drop-3" type="text" component={customInput} /> </fieldset>
                                                    </span>
                                                    <span className="td"><fieldset className="sf-form">
                                                        <Field name="drop-4" type="text" component={customInput} /> </fieldset>
                                                    </span>
                                                    <span className="td"><fieldset className="sf-form">
                                                        <Field name="" component={CustomTimePicker} /> </fieldset> </span>
                                                    <span className="td"><fieldset className="sf-form">
                                                        <Field name="" component={CustomTimePicker} /> </fieldset> </span>
                                                    <span className="td"><fieldset className="sf-form">
                                                        <Field name="" component={CustomTimePicker} /> </fieldset> </span>
                                                    <span className="td"> <strong>0.00</strong></span>
                                                    <span className="td">Active</span>
                                                    <span className="td">
                                                        <button className='bnt bnt-active' type='button'>
                                                            Save</button>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        {/* </ScrollArea> */}
                                        <button className="normal-bnt my-3">+ Add new row</button>
                                        <form>
                                            <div className="sf-c-table org-user-table mb-0">
                                                <div className="tr">
                                                    <span className="th">Date</span>
