...
class PreviewSignSWMS extends React.Component {
    ...
    render() {
        ...
        const { jobDetails, swmsDoc, taskSWMS, allStaffList } = this.props;
...
export default connect(mapStateToProps, mapDispatchToprops)(PreviewSignSWMS);