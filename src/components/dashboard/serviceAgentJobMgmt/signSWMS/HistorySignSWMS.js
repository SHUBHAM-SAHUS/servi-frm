...
import { Icon, Collapse, Table, Dropdown } from 'antd';
...
class HistorySignSWMS extends React.Component {

    printDocument = () => {
        const { jobDetails, swmsSignDetails, taskSWMS, allStaffList } = this.props;

        var obj = pdf(<SignSWMSPdf jobDetails={jobDetails} swmsSignDetails={swmsSignDetails} taskSWMS={taskSWMS} allStaffList={allStaffList} />).toBlob();
    ...
    render() {
        ...
        const { jobDetails, swmsDoc, taskSWMS, allStaffList, versionNo } = this.props;
            ...
            <div className="sf-jobdoc-preview sf-history-preview">
                <div className="sf-card-wrap">
                    ...
                    <div className="jdp-big-cntr-head">
                        <h1>Sign SWMS Version {versionNo}</h1>
                    </div>
                            ...
                            <div className="data-v-row">
                                <div className="data-v-col">
                                    <div className="view-text-value">
                                        ...
                                        <span>{jobDetails.quote && jobDetails.org_details.abn_acn}</span>
                                    </div>
                                </div>
                                <div className="data-v-col">
                                    <div className="view-text-value">
                                        <label>{Strings.phone}</label>
                                        <span>{jobDetails.quote && jobDetails.org_details.contact_person_phone}</span>
                                    </div>
                                </div>
                                <div className="data-v-col">
                                    <div className="view-text-value">
                                        <label>{Strings.email_txt}</label>
                                        <span>{jobDetails.quote && jobDetails.org_details.contact_person_email}</span>
                                    </div>
                                </div>
                                <div className="data-v-col">
                                    <div className="view-text-value">
                                        <label>{Strings.address_txt}</label>
                                        <span>{jobDetails.quote && jobDetails.org_details.address}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="task-name-list">
                                        <div className="task-table">
                                            <div className="sf-c-table">
                                                ...
                                                {allStaffList && Array.isArray(allStaffList) && allStaffList.length > 0 ?
                                    ...
                                    {this.props.swmsSignDetails[0] && this.props.swmsSignDetails[0].job_swms_sign_offs ?
                                        this.props.swmsSignDetails[0].job_swms_sign_offs.map(sign =>
                                            <tr>
                                                ...
                                                <td><img className="sign-image" src={sign.sign} alt="SF logo" /></td>
...
const mapStateToProps = (state) => {
    return {
        ...
        swmsSignDetails: state.sAJobMgmt.swmsSignHistory,
...
export default connect(mapStateToProps, mapDispatchToprops)(HistorySignSWMS);