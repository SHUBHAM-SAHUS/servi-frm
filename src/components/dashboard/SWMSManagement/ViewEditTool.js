...
import UpdateSingleTool from "./UpdateSingleTool";
...
class ViewEditTool extends React.Component {
    constructor(props) {
        super(props);
                        ...
                        <span className="td">
                            <fieldset className="sf-form update-signle-tool-type">
                                <Field
                                    ...
                                    mode="multiple"
                                    options={extactToolDefaults(this.props.orgSWMS)}
                        ...
                        <span className="td">
                            <fieldset className="sf-form">
                                <Field
                                    ...
                                    onChange={(val) => this.props.onChange(`tools[${index}].active`, +val)}
                                />
                            </fieldset>
                        </span>
    ...
    handleAddCategory = fromData => {
        this.props.addToolType(fromData)
            .then((flag) => {
                this.props.reset();
            })
            .catch((error) => {
                        ...
                        <div className="sf-card-wrap">
                            ...
                            <div className="sf-card mb-4">
                                <div className="sf-card-head abb-1 d-flex justify-content-between align-items-center">
                                    <h2 className="sf-pg-heading">Tool Types</h2>
                                ...
                                <div className="sf-card-body mt-2">
                                    <div className="sf-c-table org-user-table swms-view-table">
                                        ...
                                        {orgSWMS && orgSWMS.tools && orgSWMS.tools.map(
                                            cat => {
                                                var inline = inlineCat.findIndex(id => id === cat.id);
                                                if (inline !== -1) {
                                                    return <UpdateSingleTool
                                                ...
                                                return <div className="tr">
                                                    ...
                                                    <span className="td">
                                                        <div id="confirmPopPo">
                                                            ...
                                                            <Popconfirm
                                                                title={"Are you sure You want to delete Tool Type"}
                                    ...
                                    <form onSubmit={handleSubmit(this.handleAddCategory)}>
                                        <FieldArray name="tools" component={this.renderMembers} />
                                        {
                                            this.props.formValues && this.props.formValues.tools && this.props.formValues.tools.length > 0
...
const mapStateToProps = state => {
    return {
        formValues: state.form.ViewEditTool && state.form.ViewEditTool.values,
