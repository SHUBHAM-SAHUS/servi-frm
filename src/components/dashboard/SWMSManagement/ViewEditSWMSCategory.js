...
class ViewEditSWMSCategory extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleAddCategory = fromData => {
        this.props.addSWMSCat(fromData)
            .then((flag) => {
                this.props.reset();
            })
            .catch((error) => {
                            ...
                            <div className="sf-card mb-4">
                                ...
                                <div className="sf-card-body mt-2">
                                    ...
                                    <form onSubmit={handleSubmit(this.handleAddCategory)}>
                                        <FieldArray name="swms_category" component={this.renderMembers} />
                                        {
                                            this.props.formValues && this.props.formValues.swms_category && this.props.formValues.swms_category.length > 0
...
const mapStateToProps = state => {
    return {
        formValues: state.form.ViewEditSWMSCategory && state.form.ViewEditSWMSCategory.values,
...
export default compose(
    ...
    reduxForm({
        form: "ViewEditSWMSCategory",
        validate,
        onSubmitFail: (errors, dispatch, sub, props) => {
            handleFocus(errors, "#");
        }
    })
)(ViewEditSWMSCategory);
