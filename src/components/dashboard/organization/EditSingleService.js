...
import { validate, isServiceRequired, isCategoryRequired, isSubCategoryRequired } from '../../../utils/Validations/organizationValidaton';
...
export default compose(
    ...
    reduxForm({ form: 'EditSingleService', validate, enableReinitialize: true ,
