...
import MyDocument from '../scope-doc/ScopeDocQuotePdf';
import { pdf } from '@react-pdf/renderer';
import { goBack, handleFocus, DeepTrim } from '../../../utils/common';
...
class EmailJobReport extends React.Component {
    ...
    onSubmit = async formData => {
        ...
        formData = ({ ...formData, 'job_id': 1, 'job_number': 'J2334324', 'attachment': this.blobData });

        this.props.action.sendEmailJobReport(formData)
            .then((res) => {
                ...
                // window.history.back();
                this.props.history.push('/dashboard/jobReport')
            }).catch((message) => {
                notification.error({
...
export default compose(
    ...
    reduxForm({ form: 'EmailJobReport', validate: JobDocsEmailvalidate, enableReinitialize: true ,
