...
class EmailJobSignOffSheet extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            toggleCc: false,
    ...
    onSubmit = async formData => {
        ...
        this.props.action.sendSwmsSheetEmail(formData)
            .then((res) => {
                ...
                goBack(this.props)
                this.props.history.push('/dashboard/sign-off-sheet')
            }).catch((message) => {
                notification.error({
                            ...
                            <div className="sf-card-body">
                                ...
                                <div className="email-form">
                                    <fieldset className="form-group sf-form">
                                        <Field
                                            label=/*{Strings.from_profile}*/"Boogie Woogie"
                                            name="from_profile"
                                            type="text"
                                            id="name"
...
export default compose(
    ...
    reduxForm({ form: 'EmailJobSignOffSheet', validate: JobDocsEmailvalidate, enableReinitialize: true ,
