...
import { extactToolDefaults } from '../../SWMSManagement/ViewEditTool';
import { CustomSelect } from '../../../common/customSelect';

class AddToolType extends React.Component {
    ...
    onSubmit = async formData => {
        ...
        this.props.addToolType({ tools: [formData] }).then((flag) => {
            this.props.reset();
            this.props.close()
        })
            .catch((message) => {
...
export default compose(
    ...
    reduxForm({
        form: 'AddToolType', validate, enableReinitialize: true,
