...
class AddHRWForm extends React.Component {
    ...
    onSubmit = async formData => {
        ...
        this.props.addHRW({ high_risk_work: [formData] }).then((flag) => {
            this.props.reset();
            this.props.close()
        })
            .catch((message) => {
...
export default compose(
    ...
    reduxForm({
        form: 'AddHRWForm', validate, enableReinitialize: true,
