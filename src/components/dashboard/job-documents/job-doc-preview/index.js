...
class JobDocumentPreview extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            checkedList: [],
    ...
    componentDidMount() {
        ...
        let { match, getServiceAgentAllStaff, getJobDetails } = this.props;
        let jobId = match && match.params && match.params.jobid
        if (jobId) {
    ...
    render() {
        const { staffList, jobDetails, certificateList, step, staffLists } = this.props;
        const {
        ...
        return (
            <>
                <div className="main-container white-back pb-5">
                    ...
                    <div className="text-left defalut-mai">
                        {/* <AddTasks /> */}
...
export default connect(mapStateToProps, mapDispatchToprops)(JobDocumentPreview);